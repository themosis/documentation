...
Visit your project home page and you should be granted with a welcome message. Congratulations! You have installed WordPress and the Themosis framework. To log into the admin screen use /login. /wp-admin will redirect to home.
